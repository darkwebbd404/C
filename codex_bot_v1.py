                ...
                if "8" in parsed_data["5"]["data"] and "data" in parsed_data["5"]["data"]["8"]:
                    ...
                    if uexmojiii == "DefaultMessageWithKey":
                        ...
                        clients.send(
                            self.GenResponsMsg(
                                f"""[C][B]
سمعتُ أنك تريد معرفة من هم المشرفون؟

أشعر أنك تريد شراء مشرف أيضًا!

أو على الأقل تريد شراء خادم باسمك

صحيح؟ حسنًا، يمكنك ذلك!

الاتصال فقط بـ [00ff00]C O D E Xᵀᴱᴬᴹ[ffffff]
[C][B]
@S_DD_F

بالإضافة إلى ذلك، يمكنك إرسال [00ff00]/🗿help [ffffff]حتى تتمكن من التعرف على أوامري!.
[C][B]
Bot Made By [00ff00]C O D E Xᵀᴱᴬᴹ.""",uid
                            )
                        )
                else:
                    pass
...
####################################
            ...
            if "1200" in data.hex()[0:4] and b"/ai" in data:
                try:
                    ...
                    clients.send(self.GenResponsMsg("ﺟﺎري اﻟﻤﻌﺎﻟﺠﺔ...", uid))
            ...
            if "1200" in data.hex()[0:4] and b"/clan/" in data:
                try:
                    ...
                    parsed_data = json.loads(json_result)
                    uid = parsed_data["5"]["data"]["1"]["data"]
                    clients.send(self.GenResponsMsg("جاري جلب معلومات كلان...", uid))
...
[ffffff]
معرفة معلومات الكلان استعمل:
[00ff00]/🗿clan/
[ffffff]
زيادة زوار الحساب استعمل:
[00ff00]/🗿visit/104[c]145[c]933[c]49
[ffffff]
...
[FFC0CB]IG : [C][B]om1p9
[69FFB4]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[C][B][FFA500]CODEX HAT TEAM -> DEV BY FOX
"""
	                time.sleep(1)
