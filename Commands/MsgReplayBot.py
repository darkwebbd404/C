import threading;import jwt;import random;import json;import requests;import google.protobuf;import datetime;from datetime import datetime;import my_message_pb2;import data_pb2;import base64;import logging;import re;import socket;import jwt_generator_pb2;import os;import binascii;import sys;import psutil;import MajorLoginRes_pb2;import time;from byte import*;from time import sleep;from google.protobuf.timestamp_pb2 import Timestamp;from google.protobuf.json_format import MessageToJson;from protobuf_decoder.protobuf_decoder import Parser;from threading import Thread;from Crypto.Cipher import AES;from Crypto.Util.Padding import pad, unpad
####################################
ip_message = "98.98.162.78"
port_message = 39698
...
class FF_CLIENT(threading.Thread):
    ...
    def connect(self, tok, host, port, packet, key, iv):
        global clients;global socket_client;ip_message;port_message
        clients = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
        port = int(port)
        clients.connect((host, port))
        clients.send(bytes.fromhex(tok))
        thread = threading.Thread(
            target=self.sockf1, args=(tok, ip_message, port_message, "anything", key, iv)
        )
        ...
        while True:
            ...
            if data == b"":
                break
####################################
            if "1200" in data.hex()[0:4] and b"/msg" in data:
                try:
...
[11EAFD][b][c]
°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
test message in bot freind Kkkkkkkkk
